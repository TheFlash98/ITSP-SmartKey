...
public class EndTimeActivity extends AppCompatActivity implements
                                        ...
                                        alertDialogBuilder.setPositiveButton("Okay",
                                                new DialogInterface.OnClickListener() {
                                                    ...
                                                    public void onClick(DialogInterface arg0, int arg1) {
                                                        Toast.makeText(EndTimeActivity.this,"Try Again!",Toast.LENGTH_LONG).show();
                                                    }
                                                });
